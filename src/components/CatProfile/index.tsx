...
const CatProfile: React.FC = () => {
  ...
  if (showAdoptionForm && cat) {
    return <AdoptionForm catId={cat.id} onClose={handleCloseForm} onSuccess={handleAdoptionSuccess} status={currentStatus} />;
  }
  ...
  return (
    <div>
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <PageHeader title="Perfil del gato" clickbutton={handleBackToList} status={currentStatus} />
